								...
								?>
									...
									<div class="product">
										<div class="product-img">
											<img src="public/img/<?php echo $value['image'] ?>" alt="" style="width: 263px;" height="263px">
										...
										<div class="product-body">
											...
											<h3 class="product-name"><a href="product-detail.php?id=<?php echo $value['id'] ?>"><?php echo $value['name'] ?></a></h3>
										...
										<div class="add-to-cart">
											<button class="add-to-cart-btn" type="submit" name="add_to_cart"><a href="action/cart.php?id=<?php echo $value['id'] ?>" target="_self"><i class="fa fa-shopping-cart"></i> add to cart</a></button>
										</div>
									</div>
								<?php
								endforeach;
		...
		<div class="row">
			<div class="col-md-12">
				<div class="newsletter">
					<p>Sign Up for the <strong>NEW PRODUCT</strong></p>
					<form>
